...
public class RemoveDeliveryController implements Serializable,Initializable{
	...
	@FXML
	void removedelivery(ActionEvent event) throws NothingIsSelectedException {

		try {
			if(deliveries.getValue()==null)
				throw new NothingIsSelectedException();

			else if(Model.Restaurant.getInstance().removeDelivery(deliveries.getValue()))
			{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		HashMap<Integer,Delivery> delivery = Model.Restaurant.getInstance().getDeliveries();
